# Contributing to node-modbus

We have some guidelines for the package.
...
At a minimum, please include:
 ...
 - Version of node.js? (should be >=v4.7.0)
 - Version of node-modbus? (should be >=v4.0.0)
 
 - What is your platform? (Linux, macOS, ...)
 - What does `DEBUG=*` say? (log files are welcome)
...
Some basic rules include:
 ...
 - all files should get the MIT license in the header.
